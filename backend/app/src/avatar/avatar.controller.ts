import { Controller, Post, UseInterceptors, Bind, UploadedFile, UseGuards, Get, Res, Param } from '@nestjs/common';
...
export class AvatarController {
	...
	@Post()
	@UseInterceptors(FileInterceptor('file', multerOptions('/srv/uploads/avatar')))
	@Bind(UploadedFile())
